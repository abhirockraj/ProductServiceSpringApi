package com.springBootMegaProject.productService;
...
class ProductServiceApplicationTests {
	@Container
	static MongoDBContainer objMongodb = new MongoDBContainer("mongo:4.4.2");
	@Autowired
	...
	static void setProperties(DynamicPropertyRegistry dynamicPropertyRegistry){
		dynamicPropertyRegistry.add("spring.data.mongodb.url", objMongodb::getReplicaSetUrl);
	}
...
//		this will convert pojo to json
